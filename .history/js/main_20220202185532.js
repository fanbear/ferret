document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnMore) {
        ...
        function countProduct() {
            ...
            return function () {
                count += 3;
                document.querySelector('.product__group-item').style.maxHeight = `368px * ${count} + ${count * 30}px - 30px`;
                return count;
            }
        }
        ...
        btnMore.addEventListener('click', function () {
            const width = document.querySelector('.product__group-item').style.maxHeight;
            const s = productGroup.length / 3 * 368 + 30 * productGroup.length / 3 - 30;
            console.log(s);
