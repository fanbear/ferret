document.addEventListener('DOMContentLoaded', function () {
    ...
    function btnMoreShow() {
        ...
        const productListUpdate = document.querySelectorAll('.product__group-item .group__item-product ');
        const item = Array.from(productListUpdate).map((item) => item.classList.contains('group__item-product-hide')).length
        console.log(item);
